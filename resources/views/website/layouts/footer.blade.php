                    ...
                    <div class="about-the-store">
                        ...
                        <ul class="footer-contact-info">
                            ...
                            <li><i class='bx bx-envelope'></i> <a
                                    href="https://templates.hibootstrap.com/cdn-cgi/l/email-protection#c9a1aca5a5a689b1bda6a7e7aaa6a4"><span
                                        class="__cf_email__"
                                        data-cfemail="bcd4d9d0d0d3fcc4c8d3d292dfd3d1">[email&#160;protected]</span></a>
                            </li>
                        </ul>
                    </div>
        ...
        <div class="footer-bottom-area">
            <div class="row align-items-center">
                <div class="col-lg-12 col-md-12">
                    <p class="text-center">© Developed By <a href="https://mohamadmansour.me/"
                            target="_blank">Mohamad Mansour</a>
                    </p>
                </div>
            </div>
        </div>
